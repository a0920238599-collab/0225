...
import { LayoutDashboard, Settings, ShoppingBag, LogOut, Images } from 'lucide-react';

interface SidebarProps {
  currentView: 'dashboard' | 'settings' | 'product_library';
  onChangeView: (view: 'dashboard' | 'settings' | 'product_library') => void;
  onLogout: () => void;
}
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, onChangeView, onLogout }) => {
  const menuItems = [
    ...
    { id: 'product_library', label: '产品图库', icon: Images },
